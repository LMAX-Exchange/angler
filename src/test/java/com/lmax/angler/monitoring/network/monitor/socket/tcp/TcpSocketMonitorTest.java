...
public abstract class TcpSocketMonitorTest<T>
{
    ...
    public void shouldSampleMonitoredSockets() throws Exception
    {
        ...
        assertEntry(recordedEntries.get(1), "0.0.0.0", 56150, 0, 0, 13597);
        assertEntry(recordedEntries.get(2), "192.168.122.1", 53, 166, 144, 15292);
    }
    ...
    public void shouldNotNotifyHandlerOfUnchangedEntries() throws Exception
    {
        ...
        assertEntry(recordedEntries.get(0), "0.0.0.0", 56150, 1, 0, 13597);
        assertEntry(recordedEntries.get(1), "192.168.122.1", 53, 166, 0, 15292);
    }
